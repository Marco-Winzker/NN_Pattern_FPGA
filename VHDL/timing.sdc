...
# (c) Marco Winzker, Hochschule Bonn-Rhein-Sieg, 03.01.2018, 4.2.2022
...
create_generated_clock -name output_n_clk -source [get_ports {clk}] -master_clock input_clk -add [get_ports {clk_n_o}]
